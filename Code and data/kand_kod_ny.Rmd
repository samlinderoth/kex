...
print("var")
max(result_jeff_df$model_var)
mean(result_jeff_df$model_var)
min(result_jeff_df$model_var)
var(result_jeff_df$oos_result)

print("mean")
max(result_jeff_df$model_mean)
mean(result_jeff_df$model_mean)
min(result_jeff_df$model_mean)
mean(result_jeff_df$oos_result)
...
print("var")
max(result_samp_df$model_var)
mean(result_samp_df$model_var)
min(result_samp_df$model_var)
var(result_samp_df$oos_result)

print("mean")
max(result_samp_df$model_mean)
mean(result_samp_df$model_mean)
min(result_samp_df$model_mean)
mean(result_samp_df$oos_result)
...
wilcox.test(result_conj_df$oos_result, results_omx_df$ret, paired = TRUE,
mu=0, alternative="two.sided", conf.level=0.95, conf.int=TRUE)
